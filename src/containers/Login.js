...
const Login = () => {
    ...
    <div className={styles.loginContainer}>
        <div> Login </div>
        <Input label="email" type="email" onChange={debounce(handleInputChange, 500)} data-label='email' className={styles.inputBox} />
        <Input label="password" type="password" onChange={debounce(handleInputChange, 500)} data-label='password' className={styles.inputBox} />
